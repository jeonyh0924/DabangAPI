...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='recentlycomplexlis',
            name='complex_ins',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='posts.ComplexInformation', verbose_name='단지정보'),
        ),
        migrations.AddField(
            model_name='recentlycomplexlis',
            name='user',
